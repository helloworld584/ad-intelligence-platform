...
export default function DashboardPage() {
  return (
    <main className="min-h-screen bg-[#1a1f2e] px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Legend */}
        <div className="mt-8 flex flex-wrap items-center gap-4 rounded-lg border border-[#2d3448] bg-[#242938]/50 px-4 py-3">
